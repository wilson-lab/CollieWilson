...
%          1/27/25 - MC lower current for 025
%

function [iInjOut, iInjParams] = alterStepIInjLow(settings, duration)

    % set parameters
    iInjParams.stepUpAmp = 40;  % depolarizing step amplitude (pA)\
    iInjParams.stepDownAmp = 40;  % hyperpolarizing step amplitude (pA)
