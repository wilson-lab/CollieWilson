% batteryStimG4PanelsFictracEphys_IInjLow.m
%
...
%
% ADAPTED: 01/27/2025 by MC injects lower current for 025
%
function [rawData, inputParams, rawOutput] = batteryStimG4PanelsFictracEphys_IInjLow(settings,duration,pattN,funcN,optostim)
...
[iInjOutput, iInjParams] = alterStepIInjLow(settings, duration);
