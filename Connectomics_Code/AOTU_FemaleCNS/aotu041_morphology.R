...
# metadata
aotu041_meta <- flytable_meta("AOTU041")
aotu041_right <- aotu041_meta[grepl("right", aotu041_meta$side), ]
aotu041_left <- aotu041_meta[grepl("left", aotu041_meta$side), ]

# Fetch meshes
right_mesh <- read_cloudvolume_meshes(aotu041_right$root_id)
left_mesh <- read_cloudvolume_meshes(aotu041_left$root_id)
...
# ---- Save
ggsave("aotu041_morphology.png", plot = p, width = 8, height = 8, dpi = 300)
