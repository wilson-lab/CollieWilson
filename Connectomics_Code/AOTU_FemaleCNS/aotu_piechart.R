...
aotu019R_meta <- aotu019_meta[grepl("right", aotu019_meta$side), ]
aotu019L_meta <- aotu019_meta[grepl("left", aotu019_meta$side), ]

aotu025_meta <- flytable_meta("AOTU025")
aotu025R_meta <- aotu025_meta[grepl("right", aotu025_meta$side), ]
aotu025L_meta <- aotu025_meta[grepl("left", aotu025_meta$side), ]
