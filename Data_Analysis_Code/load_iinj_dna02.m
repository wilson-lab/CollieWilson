...
% as well as the pooled analysis pipeline for DNa02 neurons.
%
% Inputs:
...
%   3. Executes preprocessing for individual experiments (via preprocess_iinj_dna02).
%   4. Runs the pooled analysis pipeline for all experiments (via pipeline_iinj_dna02).
%
% Outputs:
%   - Processed data is saved into the specified experiment folder.
%
function load_iinj_dna02(userClear)
%% load in all experiments of interest
% pick which battery analysis to run through pipeline
exptFolder = 'DNa02 IInj Hold';
...
for nf = 1:nExpt
    ...
    preprocess_iinj_dna02(exptFolder,thisFly,trackLR(nf))
end
...
pipeline_iinj_dna02(exptFolder)
end
