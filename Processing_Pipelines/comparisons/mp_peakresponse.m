...
peak_srR_AOTU019 = AOTU019_data.peak_srR;  % Peak firing rates (rows: animals, columns: positions)
sweepPosR_AOTU019 = AOTU019_data.sweepPosR;  % Sweep positions

peak_srR_AOTU025 = AOTU025_data.peak_srR;  % Peak firing rates (rows: animals, columns: positions)
...
restricted_srR_AOTU019 = peak_srR_AOTU019(:, idx_AOTU019);  % Columns are common positions
restricted_srR_AOTU025 = peak_srR_AOTU025(:, idx_AOTU025);
...
% Display results
disp(anova(lme));  % ANOVA table with fixed effects and interaction
